...
$gphone=$_POST['phone'];
    ...
    $Query="UPDATE users SET name='$gname',phone='$gphone',address='$gaddress' WHERE email='$user'";
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         ...
                         <form action="" method="post" class="wow fadeInUp" >
                              ...
                              <input type="text" class="form-control" id="cf-name" name="name" value="<?php echo $uname; ?>">
                              <input type="text" class="form-control" id="cf-name" name="phone" value="<?php echo $uphone; ?>">
                              <input type="text" class="form-control" id="cf-name" name="address" value="<?php echo $uaddress; ?>"="Full name">
